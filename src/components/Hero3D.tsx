...
export function Hero3D() {
  ...
  // Determine colors based on theme - cosmic palette
  const primaryColor = theme === 'light' ? '#0066ff' : '#00ffff'; // Cyan
  const secondaryColor = theme === 'light' ? '#00cc66' : '#aa00ff'; // Violet
      ...
      <div 
        ...
        style={{
          background: theme === 'light'
            ? 'linear-gradient(to bottom, rgba(245,245,245,0.7) 0%, rgba(245,245,245,0.8) 30%, rgba(245,245,245,0.8) 70%, rgba(245,245,245,1) 100%)'
            : 'linear-gradient(to bottom, rgba(0,0,0,0.7) 0%, rgba(0,0,0,0.8) 30%, rgba(0,0,0,0.8) 70%, rgba(0,0,0,1) 100%)'
        }}
      />
        ...
        >
          ...
          >
            ...
            <div className="space-y-3">
              ...
              <h1 className="relative" style={{ fontSize: 'clamp(2.5rem, 8vw, 5.5rem)', fontWeight: 800, lineHeight: 1.1, fontFamily: "'Rajdhani', sans-serif", letterSpacing: '0.02em' }}>
                <span className="inline-block">
                  ...
                  <span className="relative inline-block">
                    <motion.span
                      ...
                      className="gradient-text absolute inset-0 drop-shadow-lg"
                      style={{
                        textShadow: '0 0 20px rgba(0, 255, 255, 0.6), 0 0 40px rgba(170, 0, 255, 0.4)'
                      }}
                    >
                ...
                <span className="gradient-text" style={{
                  textShadow: '0 0 20px rgba(0, 255, 255, 0.5), 0 0 40px rgba(170, 0, 255, 0.3)'
