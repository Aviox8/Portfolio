...
const AppContent = () => {
  ...
  return (
    ...
    >
      ...
      <div
        className="fixed inset-0 animated-gradient-bg pointer-events-none"
        style={{
          zIndex: 0
        }}
        aria-hidden="true"
      ...
      {/* Custom Cosmic Cursor Glow Effect - spring-following, reduced motion aware */}
      {!prefersReducedMotion && (
        <motion.div
          className="fixed pointer-events-none z-50 w-96 h-96 rounded-full hidden md:block"
      ...
      {/* Cosmic Starfield background grid (subtle) */}
      <div
        className="fixed inset-0 pointer-events-none"
        style={{
          backgroundImage: `
            radial-gradient(circle at 20% 50%, rgba(0, 255, 255, 0.03) 0%, transparent 50%),
            radial-gradient(circle at 80% 80%, rgba(170, 0, 255, 0.03) 0%, transparent 50%),
